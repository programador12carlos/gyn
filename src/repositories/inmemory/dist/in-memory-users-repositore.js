...
var InMemoryUserRepository = /** @class */ (function () {
  ...
  [x] Criar user no banco
    ...
    InMemoryUserRepository.prototype.procurarIdUsuario = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                user = this.items.find(function (item) { return item.id === id; });
                if (!user) {
    ...
    InMemoryUserRepository.prototype.procurarGmailUsuario = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                user = this.items.find(function (item) { return item.email === email; });
                if (!user) {
                    return [2 /*return*/, null];
                }
                return [2 /*return*/, user];
    ...
    InMemoryUserRepository.prototype.criar = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                user = {
